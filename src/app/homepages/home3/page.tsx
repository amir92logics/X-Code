...
const MapComponent = dynamic(() => import("@/components/Other/MapComponent"), {
  ssr: false,
});
        ...
        <div className="category-block overflow-hidden min-[1322px]:px-10 px-4 border-b border-outline">
          <div className="list-cate style-navigation style-three">
            ...
            >
              <SwiperSlide>
                <div
                  className={`item flex flex-col items-center rounded-xl duration-300 cursor-pointer relative ${
                    activeCategory === "cabin" ? "active" : ""
                  }`}
                  onClick={() => handleCategory("cabin")}
                >
                  <span className="icon-cabin text-4xl text-variant1 duration-300"></span>
                  <div className="text-title text-variant1 whitespace-nowrap duration-300 mt-2">
                    Cabin
                  </div>
                  {activeCategory === "cabin" && (
                    <motion.div
                      layoutId="active-pill"
                      className="absolute top-auto left-0 md:-bottom-6 bottom-[-16px] w-full h-0.5 inset-0 bg-primary"
                    ></motion.div>
                  )}
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div
                  className={`item flex flex-col items-center rounded-xl duration-300 cursor-pointer relative ${
                    activeCategory === "tented cabins" ? "active" : ""
                  }`}
              ...
              <SwiperSlide>
                <div
                  className={`item flex flex-col items-center rounded-xl duration-300 cursor-pointer relative ${
                    activeCategory === "safari tents" ? "active" : ""
                  }`}
              ...
              <SwiperSlide>
                <div
                  className={`item flex flex-col items-center rounded-xl duration-300 cursor-pointer relative ${
                    activeCategory === "cottages" ? "active" : ""
                  }`}
              ...
              <SwiperSlide>
                <div
                  className={`item flex flex-col items-center rounded-xl duration-300 cursor-pointer relative ${
                    activeCategory === "tiny houses" ? "active" : ""
                  }`}
              ...
              <SwiperSlide>
                <div
                  className={`item flex flex-col items-center rounded-xl duration-300 cursor-pointer relative ${
                    activeCategory === "caravans" ? "active" : ""
                  }`}
              ...
              <SwiperSlide>
                <div
                  className={`item flex flex-col items-center rounded-xl duration-300 cursor-pointer relative ${
                    activeCategory === "log cabins" ? "active" : ""
                  }`}
              ...
              <SwiperSlide>
                <div
                  className={`item flex flex-col items-center rounded-xl duration-300 cursor-pointer relative ${
                    activeCategory === "bell tents" ? "active" : ""
                  }`}
              ...
              <SwiperSlide>
                <div
                  className={`item flex flex-col items-center rounded-xl duration-300 cursor-pointer relative ${
                    activeCategory === "tree houses" ? "active" : ""
                  }`}
              ...
              <SwiperSlide>
                <div
                  className={`item flex flex-col items-center rounded-xl duration-300 cursor-pointer relative ${
                    activeCategory === "containers" ? "active" : ""
                  }`}
