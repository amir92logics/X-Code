          ...
          <div className="content w-full relative">
            <div className="heading flex-col items-center justify-center">
              ...
              <div className="heading6 text-white text-center mt-3">
                Reserve beautiful private RV spots and campsites—found{" "}
            ...
            <div className="form-search md:mt-10 mt-6 w-full">
              <form className="bg-white rounded-lg p-5 flex max-lg:flex-wrap items-center justify-between gap-5 relative">
                ...
                <div className="relative lg:w-full md:w-[48%] w-full">
                  ...
                  <DateRangePicker
                    className={`form-date-picker box-shadow md:border-t border-outline ${
                      openDate ? "open" : ""
                    }`}
                ...
                <div className="relative lg:w-full md:w-[48%] w-full">
                  ...
                  <div
                    className={`sub-menu-guest bg-white rounded-b-xl overflow-hidden p-5 absolute top-full md:mt-5 mt-3 left-0 w-full box-shadow md:border-t border-outline ${
                      openGuest ? "open" : ""
                    }`}
                  >
                ...
                <div className="button-block flex-shrink-0 max-lg:w-[48%] max-md:w-full">
                  <div
                    className="button-main max-lg:w-full"
